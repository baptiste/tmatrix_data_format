...
Below is an example script to run SMARTIES for multiple wavelengths and export the T-matrices in `.tmat.h5` format. The script is available as standalone script [example_simple.m](/smarties/example_simple.m). A slightly more complex script is also provided which automatically adjusts the parameters to reach a given accuracy ([example_advanced.m](/smarties/example_advanced.m)).
...
Output file: [example_simple.tmat.h5](/smarties/example_simple.tmat.h5)
