...
Below is an example script to run SMARTIES for multiple wavelengths and export the T-matrices in `.tmat.h5` format. The script is available as standalone script [example_advanced.m](/smarties/example_advanced.m).
...
Output file: [example_advanced.tmat.h5](/smarties/example_advanced.tmat.h5)
