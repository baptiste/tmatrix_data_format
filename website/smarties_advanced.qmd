...
Below is an example script to run SMARTIES for multiple wavelengths and export the T-matrices in `.tmat.h5` format. The script is available as standalone script [smarties_advanced.m](/smarties/smarties_advanced.m).
