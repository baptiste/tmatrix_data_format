...
% oblate Au spheroid in water
% semi-axes a=b=20nm, c=40nm
% semi-axes a=b=30nm, c=20nm
...
epsilon = struct(...
    ...
    'material_name', 'Au', 'material_reference', 'Raschke et al 10.1103/PhysRevB.86.235147',...
    'material_keywords', 'dispersive');

geometry = struct('description',  'oblate spheroid', ...
...
comments = struct('name', 'Au oblate spheroid in water',...
    'description', 'Computation using SMARTIES, a numerically robust EBCM implementation for spheroids',...
    'keywords', 'Au, spheroid, ebcm', 'script', [mfilename '.m']);

tmatrix_hdf5('smarties_Au_water_30_20.tmat.h5', tmatrix, wavelength, epsilon,...
